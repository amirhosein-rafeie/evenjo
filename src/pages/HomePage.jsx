    ...
    <>
      ...
      <div className=" max-w-screen flex flex-col gap-4 justify-center">
        ...
        >
          ...
          <div className="flex flex-col gap-x-[<10px>] z-10 mt-40 px-4 w-full max-w-6xl" style={{ marginTop: "100px" }} >
            <h1 className="text-white text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold leading-tight">
              What <span className="text-[#D580F2]">Concert</span> would<br /> you like to go to?
            </h1>
          ...
          <div className="flex flex-col gap-5 p-4 sm:p-6 rounded-[21px] w-[90%] sm:w-full max-w-5xl mx-auto text-white mt-12 text-xl bg-[#1B1B1BCC] border border-[#303030] z-10" style={{ marginTop: "70px" }}>
            ...
            <div className="px-1 sm:px-8">
              <div className="grid grid-cols-1 sm:grid-cols-[2fr_1fr_1fr_auto] gap-4 sm:gap-6 items-center mt-2 sm:mt-4" style={{ marginBottom: "30px" }}>

                <div className="flex items-center justify-start gap-3 h-14 sm:h-16 px-2 sm:px-3" style={{ marginLeft: "40px" }}>
                  ...
                  <div>
                    ...
                    <div className="text-gray-400 text-xs sm:text-sm leading-tight" style={{ marginLeft: "15px" }}>Event Type</div>
                  </div>
                </div>
                ...
                <div className="flex justify-center sm:justify-end">
                  <button className="w-10 h-10 sm:w-14 sm:h-14 bg-[#C14FE6] hover:bg-purple-600 text-white rounded-lg transition flex items-center justify-center" style={{ marginRight: "40px" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-gray-400 text-xs sm:text-sm mt-8 sm:mt-10 z-10 w-[90%] sm:w-auto" style={{ marginTop: "15px" }}>
